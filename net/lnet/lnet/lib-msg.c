...
lnet_msg_container_cleanup(struct lnet_msg_container *container)
{
	...
	if (container->msc_finalizers != NULL) {
		kfree(container->msc_finalizers);
...
lnet_msg_container_setup(struct lnet_msg_container *container, int cpt)
{
	...
	container->msc_finalizers = kzalloc_node(container->msc_nfinalizers * sizeof(*container->msc_finalizers),
						 GFP_NOFS,
	...
	container->msc_resenders = kzalloc_node(container->msc_nfinalizers * sizeof(*container->msc_resenders),
						GFP_NOFS,
						cfs_cpt_spread_node(lnet_cpt_table(), cpt));
